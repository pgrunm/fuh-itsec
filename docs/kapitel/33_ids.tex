...
Neben den Hashwerten werden auch die Metadaten wie Dateigröße, Dateirechte, Benutzer-ID und Gruppen-ID erfasst. Durch eine zentrale Konfigurationsdatei können die Agents zentral durch den Server konfiguriert werden. 
