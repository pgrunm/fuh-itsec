...
Für die Installation des Severs muss die Quelle des OSSEC-Repository eingetragen werden. Im Anschluss kann mit \mint{shell}|sudo apt-get update| und \mint{shell}|sudo apt-get install ossec-hids-server| der Server installiert werden.  
