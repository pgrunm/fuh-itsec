...
Zur Aktivierung des Enforce Mode genügt es im Verzeichnis \enquote{debian/rules} die folgenden Zeilen im Makefile zu ergänzen:
...
Nach diesen Änderung ist statt des Complain Mode der Enforce Mode aktiv.
