...
\verb+sudo a2enmod proxy+
\verb+sudo a2enmod proxy_html+
\verb+sudo a2enmod proxy_http+
...
\verb+sudo apt-get install libapache2-mod-wsgi-py3+
...
\verb+openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout helloprivatkey.key -out hellocert.crt+
