...
und zeigt dabei sowohl blockierte als auch erlaubte Aktionen an, wie in der folgenden Ausgabe erkennbar ist:

\begin{minted}[breaklines=true]{shell}
vagrant@ubuntu-jammy:~$ sudo aa-log 
ALLOWED sfdisk open /sys/devices/pci0000:00/0000:00:14.0/host2/target2:0:0/2:0:0:0/model comm=sfdisk requested_mask=r denied_mask=r
ALLOWED run-parts exec /usr/share/landscape/landscape-sysinfo.wrapper comm=run-parts requested_mask=x denied_mask=x
ALLOWED run-parts//null-/usr/share/landscape/landscape-sysinfo.wrapper file_inherit /dev/null comm=50-landscape-sy requested_mask=wr denied_mask=wr
\end{minted}
