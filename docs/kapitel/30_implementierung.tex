...
Der relevante Teil der Nginx Konfiguration für das Reverse Proxying wird in \autoref{listing:nginx_config_hello} dargestellt.
...
Diese Konfiguration sorgt dafür, dass beim Aufruf der Domain\linebreak \url{https://hello.fernuni} die eingehende Anfrage auf den auf localhost lauschenden Docker Container auf den \ac{TCP} Port 3001 weitergeleitet wird. Ein identisches Verfahren wird für die URL \url{https://messages.fernuni} angewendet.
